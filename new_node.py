...
if len(re.findall(regexp_ip,self_ip))>0 or len(re.findall(regexp_name,self_ip))>0 or len(re.findall(regexp_ip,bootstrap_ip))>0 or len(re.findall(regexp_name,bootstrap_ip))>0:
